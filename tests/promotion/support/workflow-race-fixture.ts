...
export async function createWorkflowRaceFixture(): Promise<RaceFixture> {
  ...
  await db.query(
    "insert into public.grading_scales(id,school_id,academic_year_id,grade_level_id,name,version,is_active,effective_from,created_by) values($1,$2,$3,$4,'Race Scale',1,false,'2049-01-02',$5)",
  ...
  await db.query(
    "insert into public.aggregate_classification_scales(id,school_id,academic_year_id,grade_level_id,name,version,is_active,created_by) values($1,$2,$3,$4,'Race Classification',1,false,$5)",
    [
      ids.classification,
      ids.school,
      ids.year,
