...
if (
  ...
  throw new Error(
    "A local Supabase stack is required for teacher-assignment browser tests.",
  );
}
const result = spawnSync(
  ...
  [
    playwrightCli,
    "test",
    "tests/e2e/teacher-assignments.spec.ts",
    ...process.argv.slice(2),
  ],
  {
    env: {
      ...process.env,
      TEACHER_ASSIGNMENT_E2E: "1",
      ...
      AUTH_FLOW_SIGNING_SECRET:
        "synthetic-stage-eight-e2e-signing-secret-0123456789",
    },
    stdio: "inherit",
  },
);
