...
if (
  ...
  throw new Error(
    "A loopback-only local Supabase stack is required for marks-workflow browser tests.",
  );
const result = spawnSync(
  ...
  [
    playwrightCli,
    "test",
    "tests/e2e/marks-workflow.spec.ts",
    ...process.argv.slice(2),
  ],
  {
    env: {
      ...process.env,
      MARKS_WORKFLOW_E2E: "1",
      ...
      AUTH_FLOW_SIGNING_SECRET:
        "synthetic-stage-ten-e2e-signing-secret-0123456789",
    },
    stdio: "inherit",
  },
);
