...
insert into public.academic_years (id, school_id, name, starts_on, ends_on, status)
values
  ('c1400000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000001', 'Snapshot Behavior Following Year', '2047-01-01', '2047-12-31', 'DRAFT'),
  ('c1400000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000001', 'Snapshot Behavior Prior Year', '2045-01-01', '2045-12-31', 'DRAFT');
insert into public.terms (id, academic_year_id, name, term_number, starts_on, ends_on, status)
values
  ...
  ('c1500000-0000-4000-8000-000000000003', 'c1400000-0000-4000-8000-000000000003', 'Snapshot Behavior Decoy', 9, '2045-12-01', '2045-12-15', 'MARKS_ENTRY'),
